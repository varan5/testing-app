...
export default function Example() {
  ...
  const handleSendMessage = async () => {
    ...
    const sendMessageUrl = ApiConfig.POST_USER_CONTACT_MESSAGE;
    const messageBody = {
      firstName,
      lastName,
      email,
    ...
    await simplePostCall(sendMessageUrl, messageBody)
      .then((response) => {
  ...
  return (
    <div className="bg-gray-100">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="relative bg-while shadow-xl">
              ...
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  <MailIcon
                    ...
                    aria-hidden="true"
                  />
                  <span className="ml-3">care@drivingschool.com</span>
                </dd>
              </dl>
