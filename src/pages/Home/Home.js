...
const features = [
  {
    ...
    description: 'We have one of the worlds best teaching staffs.',
    icon: CardMembershipIcon,
  },
  {
    name: 'Community Groups',
    description: 'Get help from the instructor and other students to resolve you queries.',
    icon: GroupAddIcon,
  },
  {
    name: 'Practical Guidance',
    description: 'Daily practical driving done to boost your confidence.',
    icon: CodeIcon,
  },
  {
    name: 'Monthly Examinations',
    description:
      'Examination will be conducted at the end of the training to test your knowledge and skills.',
    icon: AssignmentIcon,
  },
  {
    name: 'License Roadmaps',
    description: 'Roadmaps for effective future plans and progress for license.',
    icon: MapIcon,
  },
  {
    name: 'Daily Doubt Support',
    description: 'We provide daily doubt support to your questions and leave you with no doubts.',
    icon: QuizIcon,
  },
                  ...
                  <div className="lg:py-24">
                    <Link to="/our-services">
                      ...
                      >
                        ...
                        <span className="ml-4 text-sm">View Our Services</span>
                    ...
                    <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-5xl">
                      <span className="block">Want to Master Driving ?</span>
                ...
                <div className="mt-12 -mb-16 sm:-mb-48 lg:m-0 lg:relative">
                  <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0">
                    ...
                    <img
                      ...
                      src="assets/gifs/driving-car-gif.gif"
                      alt=""
